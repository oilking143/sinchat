...
public class CirclePagerIndicatorDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    private float mIndicatorStrokeWidth = DP * 4;
    ...
    public void setmIndicatorStrokeWidth(float mIndicatorStrokeWidth) {
        this.mIndicatorStrokeWidth = mIndicatorStrokeWidth;
    }
